...
const Project = ({title, description, linkUrl, imgUrl, gitUrl, tools}) => (
            ...
            <div className="custom-card">
                    ...
                    <div className='custom-card__body'>
                        ...
                        <hr/>
                        <h2 className='custom-card__body-title'>Tools used</h2>
                        <div className="custom-card__tools">
                            {tools.map((t, index) => {
                                return(
                                    <>
                                    <p className="custom-card__tools-description">{t.name} </p>
                    ...
                    <div className= 'custom-card__footer'>
                            <a className="custom-card__footer-icon"  href={gitUrl} target="blank">
                            <FontAwesomeIcon icon={faGithub}/>
                            </a>
                            {
                            linkUrl && 
                            <a className="custom-card__footer-icon"  href={linkUrl} target="blank">
