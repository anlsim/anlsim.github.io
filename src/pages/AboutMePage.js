      ...
      <div className="aboutme">
        ...
        <div className="aboutme__info">
          ...
          <p className="aboutme__info__description">
            Collaborative and creative Software Developer with a keen interest
            in building responsive and scalable web apps to enhance user
            experience. Fluent in Spanish and English, accustomed to working
        ...
        <div className="container__main">
          ...
          <p className="container__description">
            ...
            <br />• Transformed business and functional needs into documented
            technical specifications in collaboration with team members.
          </p>
        </div>
      </div>
      <div className="container">
        ...
        <div className="container__main">
          <h3 className="container__subtitle">
            BACHELOR’S OF APPLIED SCIENCE DEGREE • 2019 - 2021
          </h3>
          <p className="container__subtitle-main">
            Computing and Software Development • GPA: 3.71
          </p>
          <p className="container__description">
            Lake Washington Institute of Technology • Seattle, WA
          </p>
        </div>
        <div className="container__main">
          <h3 className="container__subtitle">
        ...
        <div className="container__main">
          ...
          <p className="container__description">
            Universidad de Guadalajara - CUAAD • Guadalajara, MX
          </p>
        </div>
      </div>
    </>
